...
if init_year.to_i%400 == 0 || (init_year.to_i%4 == 0 && init_year.to_i%100 != 0)
...
while mid_year.to_i < end_year.to_i
	if mid_year.to_i%400 == 0 || (mid_year.to_i%4 == 0 && mid_year.to_i%100 != 0)
		puts "This middle year, #{mid_year}, is a leap year."
	end
	mid_year = (mid_year.to_i + 1)
end

if end_year.to_i%400 == 0 || (end_year.to_i%4 == 0 && end_year.to_i%100 != 0)
